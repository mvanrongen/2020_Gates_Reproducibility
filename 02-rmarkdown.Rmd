...
[Click here](RNotebookExample.Rmd) for an example of an R Notebook.  The sections below will go over the different parts of the R Notebook. Add RNotebookExample.Rmd to your existing R project.  
