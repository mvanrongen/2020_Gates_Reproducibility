...
2. Find a collaborator and add the collaborator to your repository. You should get a verification e-mail on the e-mail address that is registered with your GitHub account.
...
>
1. In RStudio, create a new R Markdown file in the collaborative repository and **stage**, **commit** and **push** the changes.